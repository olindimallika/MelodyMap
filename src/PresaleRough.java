...
public class PresaleRough extends LocationFinder {
    ...
    public PresaleRough(String apiKey) {
        this.apiKey = apiKey;
    }
...
// Parse the JSON response and return a list of events
    ...
    public static void main(String[] args) {
        ...
        PresaleRough ticketmasterAPI = new PresaleRough(apiKey);
        ...
        try {
            ...
            for (JSONObject event : eventList) {
                ...
                eventInfo.addEventInfo(event);
            }

// Print event URLs and presale dates
            List<String> eventUrls = eventInfo.getEventUrls();
            List<String> presaleDates = eventInfo.getPresaleDates();
